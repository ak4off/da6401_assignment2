...
def plot_sample_predictions(model, dataloader, class_names, device, num_images=16):
    model.eval()
...
# def plot_confusion_matrix(y_true, y_pred, class_names, normalize=True, save_path="confusion_matrix.png"):
# zstart debug
def plot_confusion_matrix(model, test_loader, class_names, device, normalize=True, save_path="confusion_matrix.png", use_wandb=False):
    model.eval()
    y_true, y_pred = [], []
...
def plot_sample_predictions(model, dataloader, class_names, device, num_images=16,save_path="sample_predictions.png", use_wandb=False):
    model.eval()
    images_shown, true_labels, pred_labels = [], [], []
